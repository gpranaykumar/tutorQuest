      ...
      <?php 
			...
			if (isset($_SESSION['id']) && isset($_SESSION['uname']) && isset($_SESSION['role'])) {
				...
				<?php if($_SESSION['role']=== 'student'){ ?>
				 <li class="nav-item">
					<a class="nav-link text-sucess <?php if($base=="studentHome"){ echo "active";} ?>" href="pages/home/studentHome.php">Dashboard</a>
				</li>
				<?php }else if($_SESSION['role']=== 'teacher'){ ?>
				 <li class="nav-item">
					<a class="nav-link text-sucess <?php if($base=="teacherHome"){ echo "active";} ?>" href="pages/home/teacherHome.php">Dashboard</a>
				</li>
				<?php }else if($_SESSION['role']=== 'organisation'){ ?>
				 <li class="nav-item">
					<a class="nav-link text-sucess <?php if($base=="organisationHome"){ echo "active";} ?>" href="pages/home/organisationHome.php">Dashboard</a>
				</li>
				<?php }else if($_SESSION['role']=== 'admin'){ ?>
				 <li class="nav-item">
					<a class="nav-link text-sucess <?php if($base=="admin"){ echo "active";} ?>" href="pages/admin/home.php">Dashboard</a>
				</li>
				<?php } ?>
				<li class="nav-item">
