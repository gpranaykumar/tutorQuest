      ...
      <?php 
			if (isset($_SESSION['id']) && isset($_SESSION['uname']) && isset($_SESSION['role'])) {
				...
				<?php if($_SESSION['role']=== 'student'){ ?>
				 <li class="nav-item">
					<a class="nav-link text-sucess <?php if($base=="studentHome"){ echo "active";} ?>" href="../home/studentHome.php">Dashboard</a>
				</li>
				<?php }else if($_SESSION['role']=== 'teacher'){ ?>
				 <li class="nav-item">
					<a class="nav-link text-sucess <?php if($base=="teacherHome"){ echo "active";} ?>" href="../home/teacherHome.php">Dashboard</a>
				</li>
				<?php } else if($_SESSION['role']=== 'admin'){ ?>
				 <li class="nav-item">
					<a class="nav-link text-sucess <?php if($base=="admin"){ echo "active";} ?>" href="home.php">Dashboard</a>
				</li>
				<?php } ?>
				<li class="nav-item">
