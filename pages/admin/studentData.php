                    ...
                    <tr>
                        ...
                        <?php 
                            if($row['status']==='1'){ ?>
                                ...
                                <td> 
                                    <?php $uname= $row['uname']?>
                                    <a href="admin_operation.php?uname=<?php echo $uname ?>&status=B&rol=S" class="btn btnR" title="Block" >Block</a>
                                </td>
                            ...
                            <?php } else if($row['status']==='3'){ ?>
                                ...
                                <td> 
                                <?php $uname= $row['uname']?>
                                    <a href="admin_operation.php?uname=<?php echo $uname ?>&status=UNB&rol=S" class="btn btnA" title="Block" >Unblock</a>
                                </td>
