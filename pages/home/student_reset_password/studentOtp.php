...
if (isset($_SESSION['uname']) && $_SESSION['number']) {
?>
<!DOCTYPE html>
<html lang="en">
<head>
              ...
              <div class="col-md-5">
                ...
                <form action="verification.php">
                    <hr/>
                        ...
                        <input type="text" class="form-control" id="number" placeholder="Enter contact number" value='<?php echo $_SESSION['number']?>' name="number" required disabled>
