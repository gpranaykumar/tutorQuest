    ...
    <ul class="navbar-nav  >
      ...
      <?php 
			if (isset($_SESSION['id']) && isset($_SESSION['uname']) && isset($_SESSION['role'])) {
				?>
				<?php if($_SESSION['role']=== 'organisation'){ ?>
				 <li class="nav-item">
					<a class="nav-link text-sucess active" href="../organisationHome.php">Dashboard</a>
				</li>
				<?php }?>
				<li class="nav-item">
	...
	<div class="container">
		  ...
		  <div class="row justify-content-center">
              <div class="col-md-5">
                ...
                <form action="organisationDocFun.php" method="post" enctype="multipart/form-data">
