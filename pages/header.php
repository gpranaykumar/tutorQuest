      ...
      <?php 
			...
			if (isset($_SESSION['id']) && isset($_SESSION['uname']) && isset($_SESSION['role'])) {
				...
				<?php if($_SESSION['role']=== 'student'){ ?>
				 <li class="nav-item">
					<a class="nav-link text-sucess <?php if($base=="student_home"){ echo "active";} ?>" href="home/studentHome.php">Dashboard</a>
				</li>
				<?php }else if($_SESSION['role']=== 'teacher'){ ?>
				 <li class="nav-item">
					<a class="nav-link text-sucess <?php if($base=="teacher_home"){ echo "active";} ?>" href="home/teacherHome.php">Dashboard</a>
				</li>
				<?php }else if($_SESSION['role']=== 'organisation'){ ?>
				 <li class="nav-item">
					<a class="nav-link text-sucess <?php if($base=="organisation_home"){ echo "active";} ?>" href="home/organisationHome.php">Dashboard</a>
				</li>
				<?php } ?>
				<li class="nav-item">
